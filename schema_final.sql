...
CREATE TYPE public."AgendamentoStatus" AS ENUM ('pendente', 'confirmado', 'aprovado', 'rejeitado', 'cancelado', 'concluido');
CREATE TYPE public."Gender" AS ENUM ('masculino', 'feminino', 'outro', 'nao_informar');
CREATE TYPE public."VisitStatus" AS ENUM ('ativo', 'finalizado', 'cancelado');
...
-- 1. enums.sql
-- 2. visitstatus.sql
-- 3. enums_missing.sql (duplicatas ignoradas)
-- 4. alter_status.sql
-- 5. alter_agendamento_status.sql
-- 6. database/init/01-schema.sql
--
-- ATENÇÃO: Arquivos temporários ignorados:
-- - temp_enum.sql
-- - temp-update.sql
-- ====================================================================